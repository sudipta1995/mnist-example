...
print ("{:<10} {:<20} {:<20} {:<20} {:<20} {:<20} {:<30}".format('Gamma', 'Run', 'Train', 'Dev', 'Test', 'Mean', 'Observation'))
print('------------------------------------------------------------------------------------------------------------------------------------------------')
print('------------------------------------------------------------------------------------------------------------------------------------------------')

print (gamma_val[0], '\t 1', '\t', train_acc_arr[0], '\t', valid_acc_arr[0], '\t', test_acc_arr[0], '\t', mean_arr[0], '\t', 'The results are good.')
print (gamma_val[1], '\t 2', '\t', train_acc_arr[1], '\t \t \t', valid_acc_arr[1], '\t', test_acc_arr[1], '\t', mean_arr[2], '\t', 'Overfitting. The training accuracy is 100%')
print (gamma_val[2], '\t 3', '\t', train_acc_arr[2], '\t \t \t', valid_acc_arr[2], '\t', test_acc_arr[2], '\t', mean_arr[2], '\t', 'Overfitting. The training accuracy is 100%')